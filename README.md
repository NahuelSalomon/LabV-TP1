...
## Scopes [Compile, provide, runtime, test, system]
	...
	Compile: este es el ámbito predeterminado, que se utiliza si no se especifica ninguno. Las dependencias de compilación están disponibles en todas las rutas de clases. Además, a esas dependencias se propagan a proyectos dependientes.
	Provide: esto es muy parecido a la compilación, pero indica que espera que el JDK o un contenedor lo proporcione en tiempo de ejecución. Sólo está disponible en la ruta de clases de compilación y prueba, y no es transitivo.
